...
import com.example.obd_servise.obd_connection.api.command.RegexPatterns.BUSINIT_ERROR_MESSAGE_PATTERN
import com.example.obd_servise.obd_connection.api.command.RegexPatterns.DIGITS_LETTERS_PATTERN
import com.example.obd_servise.obd_connection.api.command.RegexPatterns.ERROR_MESSAGE_PATTERN
import com.example.obd_servise.obd_connection.api.command.RegexPatterns.MISUNDERSTOOD_COMMAND_MESSAGE_PATTERN
import com.example.obd_servise.obd_connection.api.command.RegexPatterns.NO_DATE_MESSAGE_PATTERN
import com.example.obd_servise.obd_connection.api.command.RegexPatterns.STOPPED_MESSAGE_PATERN
import com.example.obd_servise.obd_connection.api.command.RegexPatterns.UNABLE_TO_CONNECT_MESSAGE_PATTERN
import com.example.obd_servise.obd_connection.api.command.RegexPatterns.UNSUPPORTED_COMMAND_MESSAGE_PATTERN
import com.example.obd_servise.obd_connection.api.command.RegexPatterns.WHITESPACE_PATTERN
